...
class Bank {
  ...
  // factory Bank.frombank({required data}) {
  //   return Bank(
...
void main() {
  for (int i = 0; i < 2; i++) {
    UserDetails obj = UserDetails.frombank(data: BankData[i]);
    StoreDetails.add(obj);
  }

  for (int i = 0; i < StoreDetails.length; i++) {
    print("isActive : ${StoreDetails[i].isActive}");
    print("Balance: ${StoreDetails[i].balance}");
    print("Age: ${StoreDetails[i].age}");
    print("Eye Color: ${StoreDetails[i].eyeColor}");
    print("Name: ${StoreDetails[i].name}");
    print("Gender: ${StoreDetails[i].gender}");
    print("Company: ${StoreDetails[i].company}");
    print("Email: ${StoreDetails[i].email}");
    print("Phone: ${StoreDetails[i].phone}");
    print("Address: ${StoreDetails[i].address}\n\n");
  }
}
